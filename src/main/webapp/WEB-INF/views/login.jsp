		...
		<div id="container-login">
			<div id="container-login-left">
				...
				<div id="header-bottom-left">
					<p><img class="icon_oval" alt="icon_oval" src='<c:url value="/resources/Image/icon_oval.png" />' /><span>Luôn cập nhật xu hướng thời trang mới nhất </span></p>
					<p><img class="icon_oval" alt="icon_oval" src='<c:url value="/resources/Image/icon_oval.png" />' /><span>Giảm hơn 50% tất cả các mặt hàng giành cho khách VIP </span></p>
					<p><img class="icon_oval" alt="icon_oval" src='<c:url value="/resources/Image/icon_oval.png" />' /><span>Tận tình tư vấn để tạo nên phong cách của bạn</span></p>
				</div>
			</div>
			...
			<div id="container-login-right">
				...
				<div id="container-social-login">
					<img class="icon_social" alt="icon_oval" src='<c:url value="/resources/Image/icon_facebook.png" />' />
					<img class="icon_social" alt="icon_oval" src='<c:url value="/resources/Image/icon_google.png" />' />
				</div>
